...
import { Eye, EyeOff, BookOpen, Sparkles, Shield, Users, Award, AlertCircle } from 'lucide-react';
import { FormField, Button, Card, CardHeader, CardTitle, CardContent } from '../../components/ui';
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="form-group">
                  <label htmlFor="password" className="block text-sm font-semibold text-gray-700 mb-2 required">
                    Contraseña
                  </label>
                  <div className="relative">
                    <input
