...
export default function ReviewsPage() {
  ...
  const loadStatistics = async () => {
    try {
      const stats = await reviewService.getMyReviewStatistics();
      setStatistics(stats);
    } catch (error) {
                      ...
                      <div key={review.id} className="border rounded-lg p-4 hover:bg-gray-50">
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(review.estadoRevision)}`}>
                                ...
                                {review.estadoRevision.replace('_', ' ')}
                              </span>
                              {review.prioridad && (
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            {review.estadoRevision === ReviewStatus.PENDIENTE && (
                              <Link
                            ...
                            {review.estadoRevision === ReviewStatus.EN_PROCESO && (
                              <Link
